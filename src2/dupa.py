...
def speech_recognize_continuous_from_file(fp):
    print('here')
    """performs continuous speech recognition with input from an audio file"""
    # <SpeechContinuousRecognitionWithFile>
    speech_config = speechsdk.SpeechConfig(subscription='45d0a99b524e4d38bfa460ba38c1b82a', region='westeurope')
    audio_config = speechsdk.audio.AudioConfig(filename=fp)
    speech_recognizer = speechsdk.SpeechRecognizer(speech_config=speech_config, audio_config=audio_config)
...
if __name__=='__main__':
    import azure_tts
    i=azure_tts.azure_tts()
#    i.talk()
    fp=i.path_join('tmp','tests','tests_inputs','azure_speech.mp3')
#    fp='''c:\\Users\\zdune\\Documents\\moonboy\\speech-enhancer\\speech-enhancer\\src2\\tmp\\tests\\tests_inputs\\azure_speech_to_text.wav'''
    print(fp)
    speech_recognize_continuous_from_file(fp)        
