...
class RestorePuncts:
    ...
    def punctuate_twice(self, text: str, lang:str=''):
        text1=self.punctuate( text=text,lang=lang)
        text2=self.punctuate( text=text1,lang=lang)
        return text2
...
if __name__ == "__main__":
    ...
    # read test file
#    with open('../tests/sample_text.txt', 'r',encoding="utf-8") as fp:
#        test_sample = fp.read()
    # predict text and print
    punctuated = punct_model.punctuate('hello world  how are you doing today i am fine thank you')
    print(punctuated)
