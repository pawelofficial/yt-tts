...
class azureTTS:
    ...
    def tts(self,fname='test', s = None):
        ...
        self._setup_audio_config(tts = True ,fname=fname, out_dir_fp = self.out_dir_fp)       # refresh audio config to refresh output file 
    ...
    def tts_from_df(self,df,colname='txt'):
